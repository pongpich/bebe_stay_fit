...
class subscriptionDiscount extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      price: 1800 - (1800 * 0.05), // 1บาท สำหรับเทส / 1800บาท สำหรับใช้จริง
            ...
            .then(function (recurring_resp) {
              ...
              if (resultCode === "00") {
                ...
                if (pageUrl.includes("localhost") || pageUrl.includes("127.0.0.1")) {
                  window.location.href = "http://localhost:3000/#/subscription_discount?status=unsuccess";
                } else {
                  window.location.href = "https://fit.bebefitroutine.com/#/subscription_discount?status=unsuccess";
                }
